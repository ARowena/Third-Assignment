...
## 2. Data required for empirical methods
...
### 2.2 Automatic data gathering and cleaning

* We gathered data from the World Development Indicators (WDI) using the [WDI Package for R](https://cran.r-project.org/web/packages/WDI/WDI.pdf).This package enables us to automatically download WDI indicators using the World Bank's APIs.
